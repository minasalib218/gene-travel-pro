      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col px-3 py-4 md:px-8 md:py-6 lg:flex-row lg:gap-8 lg:px-12">
        ...
        <aside className="mb-4 w-full lg:mb-0 lg:max-w-[330px]">
          <div className="rounded-[24px] border border-white/10 bg-white/8 p-3.5 shadow-[0_20px_80px_rgba(0,0,0,0.45)] backdrop-blur-xl md:rounded-[28px] md:p-5">
            ...
            <h1 className="mt-2 text-[24px] font-semibold leading-tight md:mt-3 md:text-3xl">
              Build your smart trip input
            </h1>
            <p className="mt-2 text-[12px] leading-5 text-white/65 md:mt-3 md:text-sm md:leading-6">
              Add the details Gene needs to search your APIs and create AI-ranked travel recommendations.
            </p>

            <div className="mt-4 h-2 w-full overflow-hidden rounded-full bg-white/10 md:mt-6">
              <div
            ...
            <div className="scrollbar-hide mt-4 flex gap-2 overflow-x-auto pb-1 md:mt-6 md:block md:space-y-2 md:overflow-visible md:pb-0">
              {steps.map((item, index) => {
                ...
                return (
                  <button
                    ...
                    className={`flex min-w-[142px] shrink-0 items-center gap-2.5 rounded-2xl border px-3 py-2.5 text-left transition-all duration-300 md:w-full md:min-w-0 md:gap-3 md:py-3 ${
                      active
                    ...
                    <div className="min-w-0">
                      <p className="truncate text-[12px] font-medium md:text-sm">{item.title}</p>
                      <p className="text-[10px] text-white/45 md:text-xs">Step {index + 1}</p>
                    </div>
                  </button>
                );
              })}
            ...
            <details className="mt-4 rounded-2xl border border-white/10 bg-black/25 p-4 md:mt-6 md:open" open>
              <summary className="flex cursor-pointer list-none items-center justify-between text-xs uppercase tracking-[0.22em] text-white/45">
                <span>Your package</span>
                <span className="text-[10px] normal-case tracking-normal text-white/50 md:hidden">Open</span>
              </summary>
            ...
            <details className="mt-3 rounded-2xl border border-white/10 bg-black/25 p-4 md:mt-6 md:open" open>
              <summary className="flex cursor-pointer list-none items-center justify-between text-xs uppercase tracking-[0.22em] text-white/45">
        ...
        <section className="flex-1">
          <div className="rounded-[28px] border border-white/10 bg-white/8 p-4 shadow-[0_20px_80px_rgba(0,0,0,0.45)] backdrop-blur-xl md:rounded-[32px] md:p-7 lg:p-8">
            {errorMessage ? (
...
function StepHeader({
  ...
  return (
    <div>
      ...
      <h2 className="mt-2 text-[22px] font-semibold md:text-3xl">{title}</h2>
      <p className="mt-1.5 max-w-2xl text-[13px] leading-5 text-white/60 md:mt-2 md:text-sm md:leading-6">{subtitle}</p>
    </div>
  );
}
...
function Input({
  ...
  return (
    <input
      {...props}
        className={`h-11 w-full rounded-2xl border bg-black/20 px-3.5 text-sm text-white shadow-[0_10px_30px_rgba(0,0,0,0.18)] outline-none transition duration-300 placeholder:text-white/35 hover:bg-black/25 focus:bg-black/25 md:h-12 md:px-4 ${
        invalid
  ...
  return (
    <div className="relative" onClick={(event) => event.stopPropagation()}>
      <button
        ...
        className={`flex h-11 w-full items-center justify-between rounded-2xl border bg-black/20 px-3.5 text-left text-sm text-white shadow-[0_10px_30px_rgba(0,0,0,0.22)] outline-none transition hover:bg-black/25 md:h-12 md:px-4 ${
          invalid
...
function TextArea({
  ...
  return (
    <textarea
      {...props}
      className={`min-h-[104px] w-full rounded-2xl border bg-black/20 px-3.5 py-3 text-sm text-white shadow-[0_10px_30px_rgba(0,0,0,0.18)] outline-none transition duration-300 placeholder:text-white/35 hover:bg-black/25 focus:bg-black/25 md:min-h-[120px] md:px-4 ${
        invalid
...
function Select({
  ...
  return (
    <select
      {...props}
      className={`h-11 w-full rounded-2xl border bg-black/20 px-3.5 text-sm text-white shadow-[0_10px_30px_rgba(0,0,0,0.18)] outline-none transition duration-300 hover:bg-black/25 focus:bg-black/25 [&>option]:bg-[#050505] [&>option]:text-white md:h-12 md:px-4 ${
        invalid
          ? "border-red-500/50 hover:border-red-400/60 focus:border-red-400 focus:shadow-[0_0_0_1px_rgba(239,68,68,0.28),0_14px_36px_rgba(239,68,68,0.14)]"
          : "border-white/10 hover:border-white/15 focus:border-[#ff7a00] focus:shadow-[0_0_0_1px_rgba(255,122,0,0.35),0_14px_36px_rgba(255,122,0,0.12)]"
      } ${className || ""}`}
      ...
      {items.map((item) => {
        ...
        return (
          <button
            ...
            className={`rounded-full border px-3 py-1.5 text-[12px] capitalize transition-all duration-300 md:px-4 md:py-2 md:text-sm ${
              active
...
function ToggleRow({
  ...
  return (
    <div className="flex items-center justify-between gap-3 rounded-3xl border border-white/10 bg-black/20 p-3.5 md:gap-4 md:p-4">
      <div>
        <p className="text-[13px] font-medium text-white/88 md:text-sm">{title}</p>
        <p className="mt-1 text-[12px] leading-5 text-white/55 md:text-sm">{description}</p>
      </div>
      <button
        type="button"
        onClick={onChange}
        className={`relative h-7 w-12 rounded-full border transition md:h-8 md:w-14 ${
          checked
      ...
      >
        <span
          className={`absolute top-0.5 h-6 w-6 rounded-full bg-white transition md:top-1 ${
            checked ? "left-[22px] md:left-7" : "left-1"
          }`}
        />
      </button>
    </div>
